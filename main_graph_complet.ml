...
(*        recherche d'une tournée optimale sur un graphe complet          *)
(*                                                                        *)
(*                                                                        *)
(**************************************************************************)
...
(* [main_graphe_complet ~path_from_root_param ~path_from_root_city]
...
*)
let main_graphe_complet ~path_from_root_param ~path_from_root_city =
  ...
  in
  let cities_list, _     =
    Tournee.get_cities ~verbose ~path_from_root_city ()
  in
